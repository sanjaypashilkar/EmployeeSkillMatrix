...
namespace SkillMatrix.Web.Controllers
{
    public class ReportController : Controller
    {
        ...
        #region ELSEVIER SKILL MATRIX
        public IActionResult SkillMatrix1()
        {
            var report = _reportService.GetSkillMatrixReport1(null);
            return View(report);
        }

        [HttpPost]
        public IActionResult SkillMatrix1(SkillMatrixFilter filter)
        {
            var report = _reportService.GetSkillMatrixReport1(filter);
            return PartialView("_FilterAndTableSkillMatrix1", report);
        }

        [HttpPost]
        public IActionResult SkillMatrix1Filter(SkillMatrixFilter filter)
        {
            var report = _reportService.GetSkillMatrixReport1(filter);
            return PartialView("_TableSkillMatrix1", report);
        }

        [HttpGet]
        public IActionResult SkillMatrix1Excel(int year, int quarter, string team, string competency, string tenure)
        {
            var filter = new SkillMatrixFilter
            {
                Year = year,
            ...
            var skillReport = _reportService.GetSkillMatrixReport1(filter);
